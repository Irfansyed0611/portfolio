...
.liquid-glass-web-approx {
  ...
  background: linear-gradient(135deg, rgb(255 255 255 / 0.3), rgb(255 255 255 / 0.08)), rgb(255 255
        255 / 0.12);
...
.liquid-glass-web-approx::before {
  ...
  background: radial-gradient(circle at 20% 0%, rgb(255 255 255 / 0.55), transparent 34%),
...
@media (prefers-color-scheme: dark) {
  .liquid-glass-web-approx {
    ...
    background: linear-gradient(135deg, rgb(255 255 255 / 0.16), rgb(255 255 255 / 0.04)), rgb(15 23
          42 / 0.42);
